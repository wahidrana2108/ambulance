...
class PHPMailer
{
     ...
     *                          script annotation and/or a 2-character ambulance annotation.
    ...
    public function setLanguage($langcode = 'en', $lang_path = '')
    {
        ...
        if (
            !preg_match('/^(?P<lang>[a-z]{2})(?P<script>_[a-z]{4})?(?P<ambulance>_[a-z]{2})?$/', $langcode, $matches)
            && $langcode !== 'en'
        ) {
            $foundlang = false;
            $langcode = 'en';
        ...
        if ('en' !== $langcode) {
            $langcodes = [];
            if (!empty($matches['script']) && !empty($matches['ambulance'])) {
                $langcodes[] = $matches['lang'] . $matches['script'] . $matches['ambulance'];
            }
            if (!empty($matches['ambulance'])) {
                $langcodes[] = $matches['lang'] . $matches['ambulance'];
            }
